 ...
 * @Date: 2024-07-12 17:14:11
 * @LastEditors: jackning 270580156@qq.com
 * @LastEditTime: 2024-12-23 17:12:09
...
const TabFaqQuick = () => {
    ...
    useEffect(() => {
        //
        form.setFieldsValue({
            showQuickFaqs: agentInfo?.serviceSettings?.showQuickFaqs,
    ...
    const onFinish = async (values: any) => {
        ...
        const agentObject: AGENT.AgentRequest = {
            ...
            serviceSettings: {
                ...
                showQuickFaqs: values.showQuickFaqs,
                quickFaqUids: values.quickFaqUids,
                // robotUid: agentInfo?.serviceSettings?.robot?.uid,
                faqUids: agentInfo?.serviceSettings?.faqs?.map((button) => button.uid),
    ...
    const handleChange = async (checked: boolean) => {
        console.log('TabFaqs handleChange', checked);
    }
        ...
        <div>
            ...
            >
                ...
                <ProFormSelect
                    name="quickFaqUids"
                    width={"md"}
                    label={intl.formatMessage({ id: "pages.advanced.quickButton" })}
