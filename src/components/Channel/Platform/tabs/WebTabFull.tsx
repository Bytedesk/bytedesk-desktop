 ...
 * @LastEditTime: 2024-12-20 17:44:35
...
import { getChatUrl } from "@/utils/configUtils";
...
const WebTabFull = () => {
    ...
    //
    const codeFullUrl = useMemo(() => {
      let url = getChatUrl() + "?org=" + currentOrg?.uid + "&t=" + THREAD_TYPE_AGENT + "&sid=" + agentInfo.uid;
    ...
    const copyFullUrl = () => {
        navigator.clipboard.writeText(codeFullUrl);
    ...
    return (
        <div>
            {/* <p>全屏窗口客服代码</p> */}
            <TextArea style={{ width: 600 }} value={codeFullUrl} rows={2} />
            <br /><br />
            ...
            <br /><br />
            <Space>
                <Button key="openFullUrl" type="primary" onClick={() => {
                    openFullUrl();
                }}>
                    预览
                </Button>
                <Button key="copyFullUrl" onClick={() => {
                    copyFullUrl();
                }}>
                    复制
                </Button>
