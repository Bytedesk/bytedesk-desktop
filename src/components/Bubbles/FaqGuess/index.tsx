 ...
 * @Date: 2024-07-11 21:32:22
 * @LastEditors: jackning 270580156@qq.com
 * @LastEditTime: 2024-07-12 16:42:41
...
import { Card, Flex, FlexItem, List, ListItem } from "@/components/ChatUI";
...
// 猜你想问
const FaqGuess = ({ content, onFaqClick }: FaqGuessProps) => {
      ...
      <Card fluid>
        <Flex>
          <div className="guess-you-aside">
            <h1>{translateString("i18n.guess.faq")}</h1>
          </div>
          <FlexItem>
            <List>
              {
