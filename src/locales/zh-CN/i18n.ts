export default {
  ...
  "i18n.transfer": "转接",
  "i18n.hide": "隐藏",
  "i18n.network.disconnected": "网络已断开-123",
  ...
  "i18n.bye": "告别",
  "i18n.tip.title": "提示",
  "i18n.tip.network.disconnected": "网络已断开-123",
  "i18n.tip.network.connected": "网络已连接-123",
  //
  "i18n.kb.name": "默认知识库",
  ...
  // 
  "i18n.ticket.process.name.group": "技能组流程",
  "i18n.ticket.process.name.group.simple": "技能组简易流程",
  "i18n.ticket.process.name.agent": "一对一流程",
} 