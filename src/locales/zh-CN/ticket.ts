...
export default {
  ...
  'ticket.form.user': '客户',
  'ticket.form.user.placeholder': '请选择客户',
  ...
  'ticket.action.process': '开始处理',
  'ticket.action.process.todo': 'TODO: 开始处理工单',
  ...
  'ticket.verify.title': '验证工单',
  'ticket.verify.content': '请验证此工单',
  'ticket.verify.pass': '通过',
  'ticket.verify.reject': '不通过',
