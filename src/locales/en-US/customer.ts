...
export default {
  ...
  'customer.info.add.crm': 'Add to CRM',
  'customer.info.add.tag': 'Add Tag',

  // Customer Basic Info
  'customer.basic.nickname': 'Nickname',
  'customer.basic.location': 'IP Location',
  'customer.basic.note': 'Note',
  'customer.basic.client': 'Client',
  'customer.basic.status': 'Status',
  'customer.basic.empty': 'N/A',

  // Block Modal
  'black.title': 'Block Settings',
  'black.type': 'Block Type',
  'black.type.required': 'Please select at least one block type',
  'black.user': 'Block User',
  'black.ip': 'Block IP',
  'black.permanent': 'Permanent Block',
  'black.until': 'Block Until',
