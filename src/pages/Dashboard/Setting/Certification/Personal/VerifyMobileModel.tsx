 ...
 * @LastEditTime: 2024-12-04 14:32:41
...
import { AUTH_TYPE_MOBILE_VERIFY, PLATFORM } from "@/utils/constants";
...
//
type VerifyMobileModelProps = {
    open: boolean,
    onSubmit: (mobile: string) => void,
    onClose: () => void,
}
const VerifyMobileModel = ({ open, onSubmit, onClose }: VerifyMobileModelProps) => {
    const intl = useIntl();
                    ...
                    <ProFormCaptcha
                        ...
                        onGetCaptcha={async (mobile) => {
                            ...
                            if (mobile && mobile.length === 11) {
                                ...
                                console.log("sendMobileCode", result);
...
export default VerifyMobileModel;
