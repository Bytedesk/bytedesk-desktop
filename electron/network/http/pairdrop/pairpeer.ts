...
import {cyrb53, randomizer} from "./helper.js";

export default class PairPeer {
    ...
    public roomSecrets: Array<string>;
    public pairKey: string;
    public publicRoomId: string;
    ...
    _setPeerId(request) {
        ...
        if (peerId && PairPeer.isValidUuid(peerId) && this.isPeerIdHashValid(peerId, peerIdHash)) {
            this.id = peerId;
        } else {
            // this.id = crypto.randomUUID();
            this.id = randomizer.getRandomString(32);
        }
    }
